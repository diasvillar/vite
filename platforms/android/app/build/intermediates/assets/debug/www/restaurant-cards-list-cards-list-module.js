(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["restaurant-cards-list-cards-list-module"],{
...
/***/ "./src/app/restaurant/cards-list/cards-list.module.ts":
/*!************************************************************!*\
  !*** ./src/app/restaurant/cards-list/cards-list.module.ts ***!
  \************************************************************/
...
/* harmony import */ var _cards_list_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cards-list.page */ "./src/app/restaurant/cards-list/cards-list.page.ts");
...
var routes = [
    {
        path: '',
        component: _cards_list_page__WEBPACK_IMPORTED_MODULE_5__["CardsListPage"]
    }
];
var CardsListPageModule = /** @class */ (function () {
    ...
    CardsListPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_cards_list_page__WEBPACK_IMPORTED_MODULE_5__["CardsListPage"]]
        })
    ], CardsListPageModule);
...
/***/ "./src/app/restaurant/cards-list/cards-list.page.html":
/*!************************************************************!*\
  !*** ./src/app/restaurant/cards-list/cards-list.page.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<ion-content fullscreen>\n\t<div class=\"header-buttons\">\n\t\t<ion-anchor (click)=\"seleciona(restaurante)\"><ion-icon src=\"assets/images/arrow-back.svg\"></ion-icon></ion-anchor>\n\t\t<ion-anchor (click)=\"goToCart(restaurante)\"><ion-icon src=\"assets/images/ic_cart.svg\"></ion-icon></ion-anchor>\n\t</div>\n\t<img src=\"{{restaurante.imgtopo}}\" class=\"bg-image\">\n\t<div class=\"content\">\n\t\t<div class=\"page-header\">Fechar conta</div>\n\t\t\n\t\t<h5>Cartões cadastrados</h5>\n\t\t<div *ngFor=\"let cPagamento of cPagamentos; let i = index;\">\n\t\t\t<ion-list class=\"card-list\">\n\t\t\t\t<ion-radio-group name=\"selecionado\" ngDefaultControl [(ngModel)]=\"radioData\">\n\t\t\t\t\t<ion-item no-padding>\n\t\t\t\t\t\t<ion-radio slot=\"end\" color=\"success\" id=\"card\" type=\"radio\" name=\"selecionado\" value=\"{{i}}\"></ion-radio>\t\n\t\t\t\t\t\t<ion-label>\n\t\t\t\t\t\t\t<div class=\"desc\">****.****.****.{{cPagamento.card_number.substring(cPagamento.card_number.length-4,cPagamento.card_number.length)}}</div>\n\t\t\t\t\t\t</ion-label>\n\t\t\t\t\t\t<ion-icon slot=\"start\" src=\"assets/images/{{cPagamento.payment_company_code}}.svg\"></ion-icon> \n\t\t\t\t\t</ion-item>\n\t\t\t\t</ion-radio-group>\n\t\t\t</ion-list>\n\t\t</div>\n\t\t<ion-button color=\"medium\" fill=\"clear\" (click)=\"newCard(restaurante)\">Cadastrar novo cartão</ion-button>\n\n\t\t<div class=\"footer-buttons\" *ngIf=\"radioData != null\" >\n\t\t\t<ion-button (click)=\"submit()\"  color=\"primary\">Finalizar Pedido</ion-button>\n\t\t</div>\n\n\t\t<div class=\"footer-buttons\" *ngIf=\"radioData == null\">\n\t\t\t<ion-button color=\"medium\">Finalizar Pedido</ion-button>\n\t\t</div>\n\t</div>\n</ion-content>\n\n<!--href=\"/order-confirmed\"-->"

/***/ }),

/***/ "./src/app/restaurant/cards-list/cards-list.page.scss":
/*!************************************************************!*\
  !*** ./src/app/restaurant/cards-list/cards-list.page.scss ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = ".card-list ion-item {\n  color: var(--ion-color-dark); }\n  .card-list ion-item .desc {\n    font-size: 13px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/restaurant/cards-list/cards-list.page.ts":
/*!**********************************************************!*\
  !*** ./src/app/restaurant/cards-list/cards-list.page.ts ***!
  \**********************************************************/
...
var CardsListPage = /** @class */ (function () {
    function CardsListPage(navCtrl, route, _alertCtrl, router, _http) {
        var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._http
                                ...
                                console.log("##### IMPRESSÃO DO CARTÃO: " + JSON.stringify(_this.cPagamentos) + "\n\n\n");
                            })
                                .catch(function (err) {
                                console.log(err);
                            })];
    ...
    CardsListPage.prototype.clearCart = function () {
        sessionStorage.removeItem('cart');
        this.seleciona(this.restaurante);
    };
    CardsListPage.prototype.goToLogin = function () {
        this.navCtrl.navigateRoot('/login');
    };
    CardsListPage.prototype.goToCart = function (restaurante) {
    ...
    CardsListPage.prototype.goToConfirmation = function (restaurante) {
        var navigationExtras = {
            queryParams: {
                "id": restaurante.id,
                "nome": restaurante.nome,
    ...
    CardsListPage.prototype.goToFail = function (restaurante) {
        var navigationExtras = {
            queryParams: {
                "id": restaurante.id,
                "nome": restaurante.nome,
    ...
    CardsListPage.prototype.newCard = function (restaurante) {
    ...
    CardsListPage.prototype.seleciona = function (restaurante) {
        console.log('Entrou na Action seleciona');
        console.log("\n endereco: " + restaurante.endereco + "\n");
        var navigationExtras = {
            queryParams: {
    ...
    CardsListPage.prototype.submit = function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_6__["ajax"]({
            ...
            if (jsonDataUser.customers.length != 0) {
                ...
                jsonDataUser.customers.forEach(function (element) {
                    if (emailUser == element.email) {
                        ...
                        _this.cart = JSON.parse(sessionStorage.getItem('cart'));
                        for (var i = 0; i < _this.cart.pedidos.length; i++) {
                            if (_this.cart.pedidos[i]['cardapio'] != null) {
                                nameProduct = (_this.cart.pedidos[i]['cardapio'].nome).replace(/\s/g, "");
                                priceProduct = _this.cart.pedidos[i]['cardapio'].preco;
                            }
                            else {
                                nameProduct = (_this.cart.pedidos[i]['cardapioGeral'].nome).replace(/\s/g, "");
                                priceProduct = _this.cart.pedidos[i]['cardapioGeral'].preco;
                            }
                            quantidadeProdutos = _this.cart.pedidos[i].quantidade;
                            ...
                            jquery__WEBPACK_IMPORTED_MODULE_6__["ajax"]({
                                ...
                                if (jsonDataProduct.products.length !== 0) {
                                    jsonDataProduct.products.forEach(function (element) {
                        ...
                        for (var acr = 0; acr < _this.cart.pedidos.length; acr++) {
                            acrescimoFinalVindi += parseInt(_this.cart.pedidos[acr]["acrescimoTotal"]);
                        }
                        bill_items.push(new Object({ product_id: 16329, amount: acrescimoFinalVindi }));
                        bill_items.push(new Object({ product_id: 16330, amount: _this.cart.dezPorCento }));
                        bill_items.push(new Object({ product_id: 16810, amount: (-_this.cart.cupomDesc) }));
    ...
    CardsListPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./cards-list.page.html */ "./src/app/restaurant/cards-list/cards-list.page.html"),
            styles: [__webpack_require__(/*! ./cards-list.page.scss */ "./src/app/restaurant/cards-list/cards-list.page.scss")],
        }),
...
//# sourceMappingURL=restaurant-cards-list-cards-list-module.js.map