...
var map = {
	"./access/login/login.module": [
		"./src/app/access/login/login.module.ts",
		"common",
		"access-login-login-module"
	],
	"./access/signup/signup.module": [
		"./src/app/access/signup/signup.module.ts",
		"common",
		"access-signup-signup-module"
	],
	"./menu/cards/cards.module": [
		"./src/app/menu/cards/cards.module.ts",
		"default~menu-cards-cards-module~menu-cards-edit-card-edit-card-module",
		"common",
		"menu-cards-cards-module"
	],
	"./menu/cards/edit-card/edit-card.module": [
		"./src/app/menu/cards/edit-card/edit-card.module.ts",
		"default~menu-cards-cards-module~menu-cards-edit-card-edit-card-module",
		"common"
	],
	"./menu/config/config.module": [
		"./src/app/menu/config/config.module.ts",
		"menu-config-config-module"
	],
	"./menu/history/history-details/history-details.module": [
		"./src/app/menu/history/history-details/history-details.module.ts",
		"common"
	],
	"./menu/history/history.module": [
		"./src/app/menu/history/history.module.ts",
		"common",
		"menu-history-history-module"
	],
	"./restaurant/about/about.module": [
		"./src/app/restaurant/about/about.module.ts",
		"common",
		"restaurant-about-about-module"
	],
	"./restaurant/cards-list/cards-list.module": [
		"./src/app/restaurant/cards-list/cards-list.module.ts",
		"common",
		"restaurant-cards-list-cards-list-module"
	],
	"./restaurant/item/item.module": [
		"./src/app/restaurant/item/item.module.ts",
		"common",
		"restaurant-item-item-module"
	],
	"./restaurant/new-card/new-card.module": [
		"./src/app/restaurant/new-card/new-card.module.ts",
		"common",
		"restaurant-new-card-new-card-module"
	],
	"./restaurant/order-cart/order-cart.module": [
		"./src/app/restaurant/order-cart/order-cart.module.ts",
		"common",
		"restaurant-order-cart-order-cart-module"
	],
	"./restaurant/order-confirmed/order-confirmed.module": [
		"./src/app/restaurant/order-confirmed/order-confirmed.module.ts",
		"default~restaurant-order-confirmed-order-confirmed-module~restaurant-order-failed-order-failed-modul~f3627c56",
		"common",
		"restaurant-order-confirmed-order-confirmed-module"
	],
	"./restaurant/order-end/order-end.module": [
		"./src/app/restaurant/order-end/order-end.module.ts",
		"common",
		"restaurant-order-end-order-end-module"
	],
	"./restaurant/order-failed/order-failed.module": [
...
var routes = [
    ...
    { path: '', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]], loadChildren: './tabs/tabs.module#TabsPageModule' },
    ...
    { path: 'tabs', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]], loadChildren: './tabs/tabs.module#TabsPageModule' },
    { path: 'restaurant', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]], loadChildren: './restaurant/restaurant.module#RestaurantPageModule' },
    { path: 'item', canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]], loadChildren: './restaurant/item/item.module#ItemPageModule' },
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _angular_http__WEBPACK_IMPORTED_MODULE_3__["HttpModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"]],
            providers: [
...
module.exports = __webpack_require__(/*! C:\Desenvolvimento\ionic\FrontEnd-ViteV2\src\main.ts */"./src/main.ts");
